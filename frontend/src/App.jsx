...
const stats = [
    ...
    { label: "Spending remaining for this Month", value: 189.37 },
    { label: "Days left in Month", value: 8 },
];
const actions = [
    {
    ...
    },
    {
        ...
        description: "Adjust or view your current income",
    },
];
...
const announcements = [
    {
        id: 1,
        title: "EZ Budget Manager 1.0",
        href: "#",
        preview:
            "Celebrate EZ Budget Manager's 1.0 release with us! We've been working hard to bring you the best budgeting experience possible.",
    },
];
